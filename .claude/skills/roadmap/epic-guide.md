...
> **Tip**: Usa `rootline tree <roadmap-root>/<epic>/ --where "<where-leaf> && <where-not-done>" --output table` para ver solo el trabajo pendiente real de un epic, sin index files ni filtrado manual. (Ver "Configuración de Filtros" en SKILL.md para los placeholders.)
