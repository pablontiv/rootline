...
- `docs/epics/` — Roadmap for features. Completed: derivation engine (E04/F04), dependency graph (E04/F05), fix proposals (E04/F10), schema migration (E07/F01), MCP server (E03/F05), v1 stem removal (E12), inference detectors (E13/F02). Pending: marketplace distribution (E03/F09), repo best practices (E05).
